...
public class Farmacia implements Comparable<Farmacia>{
    ...
    private ListLinked<Stock> stock = new ListLinked<Stock>();
	private ListLinked<Producto> producto1 = new ListLinked<Producto>();
	...
	public static void verReporteProductos(ListLinked<Producto> pro) {
		HashC<Producto> producto2 = new HashC<Producto>(pro.length());
    ...
    public static void listarStock(ListLinked<Stock> stock) {
    	ListLinked<Stock> a = new ListLinked<Stock>();
    	ListLinked<Stock> b = new ListLinked<Stock>();
    	int opcion;
    	Scanner in = new Scanner(System.in);
    	...
    	while(opcion < 1 || opcion > 2) {
    		System.out.println("Ingrese una opcion correcta por favor (1 o 2)");
    		opcion = in.nextInt();
    	}
    	switch(opcion) {
    	case 1:
